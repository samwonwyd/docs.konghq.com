...
To see a real-life example, give a look at the [Key-Auth plugin migrations](https://github.com/Kong/kong/tree/release/{{page.kong_version}}/kong/plugins/key-auth/migrations).
